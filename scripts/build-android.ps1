...
<#
.SYNOPSIS
    Builds URAE Notebook and FFI libraries for Android via cargo-ndk.
.DESCRIPTION
    Compiles for Android target architectures (arm64-v8a, armeabi-v7a, x86_64)
    using cargo-ndk and places output shared libraries in the target directory.
.PARAMETER OutputDir
...
Write-Host "============================================================"
Write-Host " Building URAE Algebra Engine for Android via cargo-ndk"
Write-Host "============================================================"
...
Write-Host "[*] Compiling crates/urae-notebook for Android architectures..."
cargo ndk -t arm64-v8a -t armeabi-v7a -t x86_64 -o $OutputDir build --package urae-notebook --release

Write-Host "[*] Compiling crates/urae-ffi for Android architectures..."
cargo ndk -t arm64-v8a -t armeabi-v7a -t x86_64 -o $OutputDir build --package urae-ffi --release
